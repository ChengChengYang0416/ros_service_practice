...
#include <ros_service_practice/my_service.h>
// OpenCV
...
class MyServer
{
  private:
    ...
    bool serviceCb(ros_service_practice::my_service::Request &req,
                   ros_service_practice::my_service::Response &res){
    ...
    // https://docs.opencv.org/2.4/doc/ros_service_practices/objdetect/cascade_classifier/cascade_classifier.html
  ...
  public:
    MyServer(): it_(nh_){
      ...
      package_path_ = ros::package::getPath("ros_service_practice");
